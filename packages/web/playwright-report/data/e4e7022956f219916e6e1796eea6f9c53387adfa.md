...
- Name: ui-states.spec.ts >> UI States - Services >> loading state shows spinner
- Location: e2e/ui-states.spec.ts:101:3
...
- banner:
  ...
  - button "Sair"
- main:
  - heading "Serviços" [level=1]
  - button "Novo Serviço"
  - table:
    - rowgroup:
      - row "Nome Descrição Preço Duração Status Ações":
        - columnheader "Nome"
        - columnheader "Descrição"
        - columnheader "Preço"
        - columnheader "Duração"
        - columnheader "Status"
        - columnheader "Ações"
    - rowgroup:
      - row "Corte Masculino Clássico Corte tesoura e máquina, finalização com pomada R$ 0,45 30 min Ativo Editar":
        - cell "Corte Masculino Clássico":
          - strong: Corte Masculino Clássico
        - cell "Corte tesoura e máquina, finalização com pomada"
        - cell "R$ 0,45"
        - cell "30 min"
        - cell "Ativo"
        - cell "Editar":
          - button "Editar"
      - row "Barba Completa Aparar, modelar e hidratar barba R$ 0,35 20 min Ativo Editar":
        - cell "Barba Completa":
          - strong: Barba Completa
        - cell "Aparar, modelar e hidratar barba"
        - cell "R$ 0,35"
        - cell "20 min"
        - cell "Ativo"
        - cell "Editar":
          - button "Editar"
      - row "Corte + Barba Combo corte clássico + barba completa R$ 0,70 45 min Ativo Editar":
        - cell "Corte + Barba":
          - strong: Corte + Barba
        - cell "Combo corte clássico + barba completa"
        - cell "R$ 0,70"
        - cell "45 min"
        - cell "Ativo"
        - cell "Editar":
          - button "Editar"
      - row "Corte Feminino Corte tesoura, modelagem e finalização R$ 0,80 60 min Ativo Editar":
        - cell "Corte Feminino":
          - strong: Corte Feminino
        - cell "Corte tesoura, modelagem e finalização"
        - cell "R$ 0,80"
        - cell "60 min"
        - cell "Ativo"
        - cell "Editar":
          - button "Editar"
      - row "Coloração Coloração completa ou retoque de raiz R$ 1,20 90 min Ativo Editar":
        - cell "Coloração":
          - strong: Coloração
        - cell "Coloração completa ou retoque de raiz"
        - cell "R$ 1,20"
        - cell "90 min"
        - cell "Ativo"
        - cell "Editar":
          - button "Editar"
      - row "Teste Serviço Descrição do teste R$ 0,50 30 min Ativo Editar":
        - cell "Teste Serviço":
          - strong: Teste Serviço
        - cell "Descrição do teste"
        - cell "R$ 0,50"
        - cell "30 min"
        - cell "Ativo"
        - cell "Editar":
